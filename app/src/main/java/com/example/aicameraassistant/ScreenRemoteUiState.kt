...
data class CameraRemoteUiState(
    ...
    val boomerangEnabled: Boolean = false,
    ...
    val faceDetectionSessionId: String = "",
    val faceOverlayEventId: Long = 0L,
    val sceneDetection: SceneDetectionState = SceneDetectionState(),
    val sceneDetectionEnabled: Boolean = false,
    val gridEnabled: Boolean = false,
    val nightModeEnabled: Boolean = false,
    val gestureCaptureEnabled: Boolean = false,
    val videoHdrSupported: Boolean = false,
    val videoHdrEnabled: Boolean = false,
    val videoQuality: String = VideoQualityOption.default.firebaseValue,
    val videoQualitySupportedValues: List<String> = emptyList(),
