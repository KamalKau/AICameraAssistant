...
data class CameraToolRailUiState(
    ...
    val gestureCaptureSupported: Boolean,
    val smartFramingEnabled: Boolean,
    val smartFramingSupported: Boolean,
    val videoHdrSupported: Boolean,
    val videoHdrEnabled: Boolean,
    val videoQuality: VideoQualityOption,
    val videoQualitySupportedValues: List<String>,
    val videoQualityChangeEnabled: Boolean,
...
data class CameraToolRailActions(
    ...
    val onSceneDetectionClick: () -> Unit,
    val onGridClick: () -> Unit,
    val onNightModeClick: () -> Unit,
    val onGestureCaptureClick: () -> Unit,
    val onSmartFramingClick: () -> Unit,
    val onVideoHdrClick: () -> Unit,
    val onVideoQualitySelected: (VideoQualityOption) -> Unit,
