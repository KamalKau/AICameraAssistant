...
fun buildCameraToolRailUiState(
    ...
    sceneDetectionSupported: Boolean = true,
    gridEnabled: Boolean,
    nightModeEnabled: Boolean,
    videoHdrSupported: Boolean,
    videoHdrEnabled: Boolean,
    videoQuality: String,
    videoQualitySupportedValues: List<String>,
    videoQualityChangeEnabled: Boolean,
    cameraMode: String,
    ...
    smartFramingEnabled: Boolean = false,
    smartFramingSupported: Boolean = true
    ...
    CameraToolRailUiState(
        ...
        sceneDetectionSupported = sceneDetectionSupported,
        gridEnabled = gridEnabled,
        nightModeEnabled = nightModeEnabled,
        gestureCaptureEnabled = gestureCaptureEnabled,
        gestureCaptureSupported = gestureCaptureSupported,
        smartFramingEnabled = smartFramingEnabled,
        smartFramingSupported = smartFramingSupported,
        ...
        videoQualitySupportedValues = videoQualitySupportedValues,
        videoQualityChangeEnabled = videoQualityChangeEnabled,
